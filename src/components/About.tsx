      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            РемонтПро — это команда профессионалов, которая превращает ваши идеи
            в реальность. Мы специализируемся на комплексном ремонте и отделке
            помещений любой сложности.
          </p>
        </div>
